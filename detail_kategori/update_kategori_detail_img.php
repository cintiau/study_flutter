...
$path="upload/$name";
$query="update detail_kategori set nama_daerah='$nama_daerah', foto_kategori='$path', asal_daerah='$asal_daerah', detail_daerah='$detail_daerah' where id_detail=$id_detail";
